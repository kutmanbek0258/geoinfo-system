...
4.  **Multi-stage Deletion:** Удаление слоя пользователем инициирует цепочку событий: удаление из GeoServer -> удаление физического файла воркером -> удаление записи из БД.
