...
- **Импорт KML:** Возможность импорта геопространственных данных из KML-файлов с автоматическим созданием проекта и распределением объектов по типам (точки, линии, полигоны).
