...
@Table(name = "project_rasters", schema = "geodata", indexes = {
        @Index(name = "ix_proj_raster_layer", columnList = "layer_id"),
        @Index(name = "ix_proj_raster_folder", columnList = "folder_id")
})
@Entity
@AllArgsConstructor
@NoArgsConstructor
...
@Setter
@Builder
public class ProjectRaster extends AuditableCustom<String> {
    @Id
