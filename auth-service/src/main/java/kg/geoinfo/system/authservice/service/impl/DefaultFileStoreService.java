...
import kg.geoinfo.system.authservice.components.FileStore;
import kg.geoinfo.system.authservice.dao.entity.FileStoreEntity;
import kg.geoinfo.system.authservice.dao.repository.FileStoreRepository;
import kg.geoinfo.system.authservice.dao.type.StoreType;
import kg.geoinfo.system.authservice.dto.FileStoreDto;
import kg.geoinfo.system.authservice.dto.HttpUrlConnectionMultipartFile;
import kg.geoinfo.system.authservice.exception.ServiceException;
import kg.geoinfo.system.authservice.mapper.FileStoreMapper;
