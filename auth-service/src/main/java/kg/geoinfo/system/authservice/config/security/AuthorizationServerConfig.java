...
import kg.geoinfo.system.authservice.config.security.granttype.password.OAuth2PasswordAuthenticationConverter;
import kg.geoinfo.system.authservice.config.security.granttype.password.OAuth2PasswordTokenAuthenticationProvider;
import kg.geoinfo.system.authservice.config.security.properties.AuthorizationServerProperties;
import kg.geoinfo.system.authservice.service.security.IntrospectionService;
    ...
    public SecurityFilterChain authServerSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.securityMatcher(endpointsMatcher)
            ...
            .exceptionHandling(exceptions -> exceptions.authenticationEntryPoint(
                new LoginUrlAuthenticationEntryPoint(SecurityConfig.LOGIN_PAGE)
            ))
