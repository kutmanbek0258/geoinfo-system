...
import kg.geoinfo.system.authservice.config.security.introspector.CustomSpringTokenIntrospection;
import kg.geoinfo.system.authservice.config.security.properties.OAuth2ResourceOpaqueProperties;
